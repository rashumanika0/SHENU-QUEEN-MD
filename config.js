...
//═══════[Required Variables]════════\\
global.owner = process.env.OWNER_NUMBER.split("94779122081,")
...
module.exports = {
  botname:   process.env.BOT_NAME === undefined ? 'RASHU-QUEEN-MD 🧚' : process.env.BOT_NAME,
  ownername: process.env.OWNER_NAME === undefined ? 'NR-RASHU-MODZ' : process.env.OWNER_NAME,
  ownernumber: process.env.OWNER_NUMBER === undefined ? '94779122081' : process.env.OWNER_NUMBER,
  ...
  packname:  process.env.PACK_INFO.split(";")[1] === undefined ? '|: #𝐈𝐓'𝐒 𝐌𝚵 𝐍𝐑 𝐑么𝐒𝐇𝐔 𝐌𝚯𝐃𝐙' : process.env.PACK_INFO.split(";")[1],	
